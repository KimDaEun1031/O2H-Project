                        ...
                        <div class="col-lg-6">
                            <div class="product-details">
                                <div class="pd-title">
                                    ...
                                    <a href="#" class="heart-icon" onclick=""><i class="icon_heart_alt"></i></a>
                                </div>
                                <div class="pd-rating">
                                ...
                                <div class="quantity">
                                    <div class="pro-qty">
                                        <input type="text" value="1" id="pv">
                                    </div>
                                    <a data-toggle="modal" href="#exampleModal" class="primary-btn pd-cart" onclick="productValue()">Add To Cart</a>
                                </div>
                                <ul class="pd-tags">
   ...
   <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    ...
    <script>
        $('.pd-cart').modal(options)
         ...
         //상품의 개수 대로 장바구니에 넣기 작업 완료(db작업후 수정)
        function productValue() {
            var pv = $('#pv').val();
            $(".modal-body").empty();
            $(".modal-body").append("<p>장바구니에 "+pv+"개의 상품이 들어갔습니다.</p>");
        }
    </script>

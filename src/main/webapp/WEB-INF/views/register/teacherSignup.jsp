...
<body>
  <div class="container">
    ...
    <form id="form" class="form" action="/register/teacherSignup" method="post">
  ...
  <div class="social-panel-container">
    <div class="social-panel">
      <p>Created with <i class="fa fa-heart"></i> by
        <a target="_blank" href="https://youtube.com">Jaeyoung Lee</a></p>
      <button class="close-btn"><i class="fa fa-meetup" aria-hidden="true"></i></button>
  ...
  <div class="floating-text">
    Team A's  <a href="https://www.youtube.com" target="_blank">3 Week Java Project</a>
  </div>

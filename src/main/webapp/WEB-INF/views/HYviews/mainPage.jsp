...
<html lang="zxx">
  <head>
    ...
    <!-- Css Styles -->
    <link rel="stylesheet" href="resources/mainPage/css/bootstrap.min.css" type="text/css" />
    <link rel="stylesheet" href="resources/mainPage/css/font-awesome.min.css" type="text/css" />
    <link rel="stylesheet" href="resources/mainPage/css/themify-icons.css" type="text/css" />
    <link rel="stylesheet" href="resources/mainPage/css/elegant-icons.css" type="text/css" />
    <link rel="stylesheet" href="resources/mainPage/css/owl.carousel.min.css" type="text/css" />
    <link rel="stylesheet" href="resources/mainPage/css/nice-select.css" type="text/css" />
    <link rel="stylesheet" href="resources/mainPage/css/jquery-ui.min.css" type="text/css" />
    <link rel="stylesheet" href="resources/mainPage/css/slicknav.min.css" type="text/css" />
    <link rel="stylesheet" href="resources/mainPage/css/style.css" type="text/css" />
  </head>

  <!-- 로그인/회원가입 메뉴 추가 -->
  <link rel="shortcut icon" href="resources/img/iconLogo.ico" />

  <!-- Bootstrap core CSS --> <!-- 2였던 곳 -->
  <link href="resources/css/mainPage/bootstrap.min.css" rel="stylesheet">
  <!-- Custom fonts for this template -->
  <link href="resources/css/mainPage/font-awesome.min.css" rel="stylesheet" type="text/css">
  <link href='https://fonts.googleapis.com/css?family=Open+Sans:300italic,400italic,600italic,700italic,800italic,400,300,600,700,800'
    rel='stylesheet' type='text/css'>
  <link href='https://fonts.googleapis.com/css?family=Merriweather:400,300,300italic,400italic,700,700italic,900,900italic'
    rel='stylesheet' type='text/css'>
  <!-- Plugin CSS -->
  <link href="resources/mainPage/magnific-popup.css" rel="stylesheet">
  <!-- Custom styles for this template -->
  <!-- 여기도 안보임 creative css -->
  <link href="resources/css/mainPage/creative.css" rel="stylesheet">
